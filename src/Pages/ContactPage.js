...
const ContactPage = () => {
    ...
    return (
      <section id="contact" className="contact py-5" style={{background: '#0e1525'}}>
        <div className="max-width container">
            <h2 className="page-title text-center pb-5" style={{color: '#fff', fontWeight: 600}}>Contact me</h2>
            <div className="contact-content row" ref={ref}>
                <motion.div className="column left col-md-6" animate={animation}>
                    ...
                    <p className="" style={{width:'90%', fontSize: '16px', color: '#ddd', fontWeight: 500}}>Email me with any questions or inquires. I would be happy to answer your questions and set up a meeting with you. </p>
                    
                    <div class="icon pl-3">
                    <div className="row">
                            <i className="fas fa-user"></i>
                            <div className="info">
                                <div className="head " style={{color:'#ddd', fontWeight: 500}}>Name</div>
                      ...
                      <div className="row">
                            ...
                            <div className="info">
                                <div className="head " style={{color:'#ddd', fontWeight: 500}}>Address</div>
                        ...
                        <div className="row">
                            ...
                            <div className="info">
                                <div className="head " style={{color:'#ddd', fontWeight: 500}}>Email</div>
