...
<motion.div class="card effect" style={{backgroundColor: 'rgb(23, 42, 69)'}} animate={animation}>
  ...
  <div class="card-body">
    ...
    <small style={{fontSize:'13px'}} class="card-text text-white">Any number except 0 is true. If the value of any variable is 0 will return false. Similarly, we get a falsy result when undefined, null, false is the return value. <a style={{fontSize: '16px'}} href="https://tarekferdos.medium.com/javascript-tricky-concepts-5cd473251497" target="_blank" rel="noopener noreferrer">Read More</a></small>
   
  </div>
  <div class="card-footer text-center">
  <small style={{fontSize:'13px'}} class="text-muted text-center">Last updated 3 weeks ago</small>
  </div>
</motion.div>
<motion.div class="card effect" style={{backgroundColor: 'rgb(23, 42, 69)'}} animate={animation}>
  ...
  <div class="card-body">
    ...
    <small style={{fontSize:'13px'}} class="card-text text-white">Code splitting is a technique whose goal is to share and load the code in part by part. This means that, it will not run the whole application code together. <a style={{fontSize: '16px'}} href="https://tarekferdos.medium.com/10-things-about-react-e6f55c0a5cd0" target="_blank" rel="noopener noreferrer">Read More</a></small>
