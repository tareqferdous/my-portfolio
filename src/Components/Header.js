...
<div className="header-wrapper" style={{paddingTop: "70px"}}>
            <div class="main-info text-center">
                ...
                <p className="text-info" style={{color: '#fff', width: '65%', textAlign:"center", paddingTop: '20px'}}>I count myself as a hardworking person. To pursue a challenging career in a
